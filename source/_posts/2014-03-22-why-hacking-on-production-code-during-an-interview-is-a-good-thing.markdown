...
A while back I seen a blog post (link) saying that he shouldn't ever hack on a production codebase during the interview for free since he was not getting paid for it. Well I strongly disagree with that, both from an interviewee and an interviewer point of view.
...
One place I interviewed at (Parallax) had another way, they asked me in for a hack day and asked if I had anything I wanted to code as a side project and then had me code that in their framework of choice. Then it was out for beers afterwards, pretty good interview. 
